...
/*
 * This file was based on a part of Composer.
 *
...
/**
 * The Compiler class compiles viphash into a phar, based on the composer compiler
 *
...
class Compiler
{
    ...
    /**
     * Compiles viphash into a single phar file
     *
     * @throws \RuntimeException
     * @param  string            $pharFile The full path to the file to create
     */
    public function compile($pharFile = 'viphash.phar')
    {
        ...
        if ($process->run() != 0) {
            throw new \RuntimeException('Can\'t run git log. You must ensure to run compile from viphash git repository clone and that git binary is available.');
        }
        ...
        $phar = new \Phar($pharFile, 0, 'viphash.phar');
...
//            ->in(__DIR__.'/../../vendor/justinrainbow/json-schema/')
    ...
    private function addFile($phar, $file, $strip = true)
    {
        ...
        if ($path === 'src/automattic/vip/hash/Application.php') {
    ...
    private function addVipHashBin($phar)
    {
        ...
        $phar->addFromString('bin/viphash.php', $content);
    }
...
EOF;
        ...
        return $stub . <<<'EOF'
require 'phar://viphash.phar/bin/viphash.php';
